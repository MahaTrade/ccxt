...
class scallop(Exchange):
    ...
    def fetch_markets_v2(self, params={}):
        ...
        for i in range(0, len(markets)):
            ...
            # https://openapi.scallop.exchange/sapi/v1/symbols
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        url = self.urls['api'][api] + '/' + version + '/' + self.implode_params(path, params)
    ...
    def handle_errors(self, statusCode, statusText, url, method, responseHeaders, responseBody, response, requestHeaders, requestBody):
        # print('url',url,statusCode,('code' in response) == False)
        if not response:
        ...
        if statusCode != 200 or ('code' in response) != False:
